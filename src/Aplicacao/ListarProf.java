 ...
 * @author Lenovo
 */
public class ListarProf extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/ListarProf.fxml"));
            ...
            stage.setTitle("LISTAR - PROFESSOR");            
