 ...
 * @author Lenovo
 */
public class RemTurmaAlunos extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/RemTurmaAlunos.fxml"));
