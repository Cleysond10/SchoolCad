 ...
 * @author Neto Cleyson
 */
public class BuscaExbDisc extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/BuscaExbDisc.fxml"));
            ...
            stage.setTitle("BUSCAR - DISCIPLINA");            
