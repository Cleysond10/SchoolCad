 ...
 * @author Lenovo
 */
public class ListarTurmaProf extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/ListarTurmaProf.fxml"));
