 ...
 */
public class ListarAluno extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/ListarAluno.fxml"));
