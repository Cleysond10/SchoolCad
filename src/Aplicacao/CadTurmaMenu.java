 ...
 * @author Lenovo
 */
public class CadTurmaMenu extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/CadTurmaMenu.fxml"));
