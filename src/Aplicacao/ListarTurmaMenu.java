 ...
 * @author Lenovo
 */
public class ListarTurmaMenu extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/ListarTurmaMenu.fxml"));
