 ...
 * @author Neto Cleyson
 */
public class BuscaTurmaAluno extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/BuscaTurmaAluno.fxml"));
