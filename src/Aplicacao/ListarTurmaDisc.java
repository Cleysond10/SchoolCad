 ...
 * @author Lenovo
 */
public class ListarTurmaDisc extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/ListarTurmaDisc.fxml"));
