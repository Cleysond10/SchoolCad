 ...
 * @author Neto Cleyson
 */
public class BuscaExbAluno extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/BuscaExbAluno.fxml"));
