 ...
 * @author Neto Cleyson
 */
public class BuscaTurmaProf extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane fxmlMenu = (AnchorPane)FXMLLoader.load(getClass().getResource("/FXML/BuscaTurmaProf.fxml"));
